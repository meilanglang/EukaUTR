...
class TransformerDecoder(nn.Module):
    ...
    Args:
        ...
        no_encoder_attn (bool, optional): whether to attend to encoder outputs_tmp
            (default: False).
    """
    ...
    def forward(
        ...
        """
        Args:
            prev_output_tokens (LongTensor): previous decoder outputs_tmp of shape
        ...
        Returns:
            tuple:
                ...
                - a dictionary with any model-specific outputs_tmp
        """
