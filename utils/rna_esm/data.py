...
from utils.rna_esm.constants import proteinseq_toks, rnaseq_toks,codon_toks,codonseq_toks
...
class Alphabet(object):
    ...
    def from_architecture(cls, name: str) -> "Alphabet":
        if name in ("ESM-1", "protein_bert_base"):
            ...
            append_eos = True
            use_msa = False
        elif name in ("codonMamba"):
            standard_toks = codon_toks["toks"]
            prepend_toks = ("<cls>", "<pad>", "<eos>", "<unk>")
            append_toks = ("<mask>",)
            prepend_bos = True
            append_eos = True
            ...
            standard_toks = codonseq_toks["toks"]#codonseq_toks
            prepend_toks = ("<cls>", "<pad>", "<eos>", "<unk>")
            append_toks = ("<mask>",)
            prepend_bos = False
            append_eos = False
